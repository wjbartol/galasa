[![SonarQube Badge](https://cicscit.hursley.ibm.com/sonar/api/project_badges/measure?project=eJATv3Maven&metric=alert_status)](https://cicscit.hursley.ibm.com/sonar/dashboard?id=eJATv3Maven)
