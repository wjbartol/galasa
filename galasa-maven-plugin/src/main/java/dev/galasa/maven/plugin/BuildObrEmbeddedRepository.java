...
public class BuildObrEmbeddedRepository extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		//*** Scan through looking for OBRs and extract all the valid bundle symbolic names
		...
		//*** Now process all dependencies and copy them to target, if they are a valid symbolicname
		for(Artifact artifact : artifacts) {
			if (artifact.getScope().equals(Artifact.SCOPE_COMPILE) && 
					!"obr".equals(artifact.getType())) {
