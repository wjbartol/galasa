...
public enum ServletErrorMessage {
    ...
    GAL5083_ERROR_USER_NOT_FOUND                      (5083, "E: Unable to retrieve a user with the given ‘loginId’. No such user exists. Check your request query parameters and try again."),
